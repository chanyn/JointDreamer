...
if __name__ == "__main__":
    ...
    pipe = Zero123Pipeline.from_pretrained('/ssddata1/data/jch/.cache/huggingface/hub/zero123-xl', torch_dtype=torch.float32)
    ...
    image_path = "./load/cvpr24/frog0_rgba.png"
    log_dir = "/home/dycpu3_8tssd/jch/exps/zero123-xl"
    num_images_per_prompt = 1
    query_pose1 = [0, 45.0, 0.0]
    elev = 10.
    azim = 60.
    ...
    images = pipe(image=rgb_256, elevation=elev, azimuth=azim, distance=3.8, height=H, width=W,
                  guidance_scale=3.0, num_inference_steps=50).images

    os.makedirs(log_dir, exist_ok=True)
    images[0].save(os.path.join(log_dir, f"elev{elev}_azim{azim}.jpg"))
